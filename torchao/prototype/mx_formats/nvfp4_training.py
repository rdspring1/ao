...
NVFP4TrainingLinear module that performs NVFP4 quantized GEMMs
...
class NVFP4TrainingConfig(AOBaseConfig):
    ...
    NVFP4TrainingLinear, which quantizes all three GEMMs (forward
...
def _nvfp4_training_transform(
    ...
    """Handler for quantize_(): replaces nn.Linear with NVFP4TrainingLinear."""
