...
def triton_rht_quantize_row_col(
    ...
    Raises:
        ...
        ValueError: If A is not bfloat16, not 2-D, not contiguous, M/N not divisible by 128, or
    ...
    assert row_global_amax.numel() == 1
    assert row_global_amax.dtype == torch.float32
